            ...
            <div class="float-left">
                ...
                <div class="dropdown float-right ml-2">
                    ...
                    >
                        ...
                        <a class="dropdown-item" href="<?= $urlManager->createUrl(['mch/mch/goods/goods','status' => 0]) ?>">下架</a>
            ...
            <?php foreach ($list as $index => $goods): ?>
                <tr>
                    ...
                    <td class="nowrap">
                        ...
                        <a class="btn btn-sm btn-primary" href="<?=$urlManager->createUrl(['mch/mch/goods/detail','goods_id'=>$goods->id])?>">商品详情</a>
